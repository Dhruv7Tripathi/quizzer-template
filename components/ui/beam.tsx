  ...
  return (
    ...
    >
      ...
      <defs>
        ...
        >
          <stop stopColor="#00ff7f" stopOpacity="0" />       {/* Light green (transparent) */}
          <stop stopColor="#00ff7f" />                        {/* Light green */}
          <stop offset="0.325" stopColor="#22c55e" />         {/* Emerald green */}
          <stop offset="1" stopColor="#14532d" stopOpacity="0" /> {/* Dark green (transparent) */}
        </motion.linearGradient>
      </defs>
    </svg>
  );
